-- W1 Task 1.1 rollback — restore pre-activation Widget Live Test guard state.
-- Reverts the narrow widget_live_test exceptions added by 20260826090000_widget_live_test_runtime_closure.sql.

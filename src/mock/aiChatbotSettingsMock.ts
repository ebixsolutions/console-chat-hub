...
export const mockFeedbackAutomationConfig: FeedbackAutomationConfig = {
  ...
  message_template_zh:
    '感謝您聯絡我們！請為今次的服務體驗評分，您的意見對我們非常重要。',
  message_template_en:
...
export const RATING_TYPES: Array<{
  ...
  { key: 'ces', label: 'CES', suffix: '(CES)', suffixStyle: 'plain', tooltip: '' },
  {
    ...
    tooltip:
      'Basic questionnaire with 3-5 fixed questions. No drag-and-drop builder. Phase 1: Template preview only.',
  },
];
...
export const DEFAULT_TEMPLATES: Record<RatingType, MessageTemplate> = {
  stars_1_5: {
    ...
    bodyEn:
      'Thank you for contacting us! Please rate your service experience from 1 to 5 stars.',
    bodyZh: '感謝您聯絡我們！請為今次的服務體驗評分（1至5星）。',
    ctaEn: 'Rate Now',
    thankEn:
      "Thank you for your feedback! We'll use your rating to improve our service.",
    thankZh: '感謝您的評分！我們會利用您的意見改善服務。',
    lowRatingEn:
      "We're sorry to hear that. A member of our team will contact you within 24 hours.",
    lowRatingZh: '我們非常抱歉！我們的客服將在24小時內聯絡您跟進。',
  },
  csat: {
    subject: 'How satisfied were you with our service?',
    bodyEn:
      'Please rate your satisfaction: Very Satisfied / Satisfied / Neutral / Dissatisfied / Very Dissatisfied.',
  ...
  nps: {
    ...
    thankZh: '感謝您的 NPS 評分！',
    lowRatingEn:
      'We are sorry to hear this. We will reach out to understand your concerns.',
  ...
  ces: {
    ...
    bodyEn:
      'Rate the effort required to resolve your issue: 1 (Very Easy) — 7 (Very Difficult).',

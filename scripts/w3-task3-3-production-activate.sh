...
[ -s "$CFG" ] || stop "Director DEV identity config missing"; source "$CFG"
...
npm run build
export W2_T2_1_PRODUCTION_AUTHORIZED=YES W2_T2_1_RUN_PRODUCTION=true
bash scripts/w2-task2-1-final-gate.sh
export W2_T2_2_PRODUCTION_AUTHORIZED=YES W2_T2_2_RUN_PRODUCTION=true
...
export W2_T2_3_PRODUCTION_AUTHORIZED=YES W2_T2_3_RUN_PRODUCTION=true W2_T2_3_PROJECT_REF="$W3_T3_3_PROJECT_REF"

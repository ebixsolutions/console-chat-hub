...
python3 - "$TARGET" <<'PY'
import os,shlex,sys
names=["SUPABASE_DB_URL","PR10_TENANT_A_BEARER_TOKEN","PR10_TENANT_B_BEARER_TOKEN","PR10_KB_TENANT_A_QUERY","PR10_KB_TENANT_B_QUERY","PR10_KB_TENANT_A_EXPECTED_DOCUMENT_ID","PR10_KB_TENANT_B_EXPECTED_DOCUMENT_ID","KB_SINGAPORE_TENANT_MAP_JSON","KB_SINGAPORE_TENANT_API_KEYS_JSON","TRAINING_OUTBOX_INTERNAL_TOKEN","SU_COACHAI_EVALUATION_ENDPOINT","SU_COACHAI_AUTH_HEADER","SU_COACHAI_AUTH_VALUE","SU_COACHAI_RESULT_TOKEN","TRAINING_KB_SYNC_INTERNAL_TOKEN"]
p=sys.argv[1]
with open(p,"w") as f:

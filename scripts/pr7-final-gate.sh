...
echo "== PRODUCTION ATOMIC ROLLBACK SOURCE GATE =="
if bash scripts/pr7-production-atomic-rollback-source-gate.sh; then
...
echo "== PREVIEW ROLE ACCEPTANCE BRIDGE SOURCE GATE =="
if bash scripts/pr8-preview-role-acceptance-source-gate.sh; then
...
echo "== CROSS-TENANT MUTATION/WRITE SOURCE GATE =="
if bash scripts/pr10-cross-tenant-mutation-write-source-gate.sh; then
